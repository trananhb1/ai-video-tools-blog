#!/usr/bin/env python3
"""Generate 600x340 VS thumbnail for InVideo vs Pictory comparison."""
...
W, H = 600, 340
OUT = "/home/tom/ai-video-tools-blog/assets/images/invideo-vs-pictory-2026-thumbnail.png"
FONT_BOLD = "/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf"
FONT_REG = "/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf"

LOGO_SOURCES = {
    "invideo": [
        "https://icon.horse/icon/invideo.io?size=large",
        "https://favicone.com/invideo.io?s=128",
        "https://www.google.com/s2/favicons?domain=invideo.io&sz=128",
    ],
    "pictory": [
        "https://icon.horse/icon/pictory.ai?size=large",
        "https://favicone.com/pictory.ai?s=128",
        "https://www.google.com/s2/favicons?domain=pictory.ai&sz=128",
    ],
}
...
def main():
    # Gradient: InVideo orange to Pictory purple via dark navy
    ...
    # Fetch logos
    invideo_logo = fetch_logo(LOGO_SOURCES["invideo"])
    pictory_logo = fetch_logo(LOGO_SOURCES["pictory"])
    ...
    for idx, logo in enumerate([invideo_logo, pictory_logo]):
        if logo:
    ...
    title = "InVideo vs Pictory 2026"
    draw.text((W // 2, 140), title, fill=(255, 255, 255), font=title_font, anchor="mt")

    # Subtitle
    sub_font = ImageFont.truetype(FONT_REG, 16)
    draw.text((W // 2, 175), "Best for Blog-to-Video?", fill=(200, 200, 220), font=sub_font, anchor="mt")

    # Subtitle 2
    sub2_font = ImageFont.truetype(FONT_REG, 13)
    draw.text((W // 2, 205), "Head-to-Head Comparison 2026", fill=(180, 180, 200), font=sub2_font, anchor="mt")

    # Feature pills
    pill_font = ImageFont.truetype(FONT_BOLD, 11)
    pills = [
        ("InVideo: Templates + AI Models", hex_to_rgb("#e65100")),
        ("Pictory: Blog-to-Video + Brand Kit", hex_to_rgb("#7b1fa2")),
    ]
    pill_y = 240
